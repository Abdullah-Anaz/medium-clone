    ...
    <main>
        ...
        <article className="max-w-3xl mx-auto p-5">
            ...
            <div className="flex items-center space-x-2 mt-2">
                ...
                <p className="font-extralight text-sm">Blog post by <span className="text-green-600">{post.author.name}</span> - Published at {new Date(post.publishedAt).toLocaleString()}</p>
            </div>
                    ...
                    serializers={
                        {
                            ...
                            link: ({href, children}: any) => (
                                <a href={href} className="text-blue-500 hover:underlined">
                                    {children}
                                </a>
                            ),
                        }
        ...
        {submitted ? (
            ...
            <h3 className="text-sm text-yellow-500">Enjoyed this articel?</h3>
